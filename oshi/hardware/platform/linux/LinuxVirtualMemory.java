...
final class LinuxVirtualMemory extends AbstractVirtualMemory
{
    ...
    LinuxVirtualMemory(final LinuxGlobalMemory linuxGlobalMemory) {
        this.usedTotalCommitLim = (Supplier<Triplet<Long, Long, Long>>)Memoizer.memoize(LinuxVirtualMemory::queryMemInfo, Memoizer.defaultExpiration());
        this.inOut = (Supplier<Pair<Long, Long>>)Memoizer.memoize(LinuxVirtualMemory::queryVmStat, Memoizer.defaultExpiration());
        this.global = linuxGlobalMemory;
    }
    
    @Override
    public long getSwapUsed() {
        return (long)this.usedTotalCommitLim.get().getA();
    }
    
    @Override
    public long getSwapTotal() {
        return (long)this.usedTotalCommitLim.get().getB();
    }
    
    @Override
    public long getVirtualMax() {
        return (long)this.usedTotalCommitLim.get().getC();
    }
    ...
    public long getSwapPagesIn() {
        return (long)this.inOut.get().getA();
    }
    
    @Override
    public long getSwapPagesOut() {
        return (long)this.inOut.get().getB();
    }
