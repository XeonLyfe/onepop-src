...
final class LinuxFirmware extends AbstractFirmware
{
    ...
    LinuxFirmware() {
        ...
        this.biosNameRev = (Supplier<Pair<String, String>>)Memoizer.memoize(Dmidecode::queryBiosNameRev);
    }
    ...
    private String queryVersion() {
        String result = null;
        if ((result = Sysfs.queryBiosVersion((String)this.biosNameRev.get().getB())) == null && (result = this.vcGenCmd.get().version) == null) {
            return "unknown";
        }
        return result;
    }
    ...
    private String queryName() {
        String result = null;
        if ((result = (String)this.biosNameRev.get().getA()) == null && (result = this.vcGenCmd.get().name) == null) {
            return "unknown";
        }
        return result;
    }
