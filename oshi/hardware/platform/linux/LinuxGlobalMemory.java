...
public final class LinuxGlobalMemory extends AbstractGlobalMemory
{
    ...
    public LinuxGlobalMemory() {
        this.availTotal = (Supplier<Pair<Long, Long>>)Memoizer.memoize(LinuxGlobalMemory::readMemInfo, Memoizer.defaultExpiration());
        this.vm = Memoizer.memoize(this::createVirtualMemory);
    }
    
    @Override
    public long getAvailable() {
        return (long)this.availTotal.get().getA();
    }
    
    @Override
    public long getTotal() {
        return (long)this.availTotal.get().getB();
    }
