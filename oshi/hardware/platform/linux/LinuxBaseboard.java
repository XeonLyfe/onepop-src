...
final class LinuxBaseboard extends AbstractBaseboard
{
    ...
    LinuxBaseboard() {
        ...
        this.manufacturerModelVersionSerial = (Supplier<Quartet<String, String, String, String>>)Memoizer.memoize(CpuInfo::queryBoardInfo);
    }
    ...
    private String queryManufacturer() {
        String result = null;
        if ((result = Sysfs.queryBoardVendor()) == null && (result = (String)this.manufacturerModelVersionSerial.get().getA()) == null) {
            return "unknown";
        }
        return result;
    }
    ...
    private String queryModel() {
        String result = null;
        if ((result = Sysfs.queryBoardModel()) == null && (result = (String)this.manufacturerModelVersionSerial.get().getB()) == null) {
            return "unknown";
        }
        return result;
    }
    ...
    private String queryVersion() {
        String result = null;
        if ((result = Sysfs.queryBoardVersion()) == null && (result = (String)this.manufacturerModelVersionSerial.get().getC()) == null) {
            return "unknown";
        }
        return result;
    }
    ...
    private String querySerialNumber() {
        String result = null;
        if ((result = Sysfs.queryBoardSerial()) == null && (result = (String)this.manufacturerModelVersionSerial.get().getD()) == null) {
            return "unknown";
        }
        return result;
    }
