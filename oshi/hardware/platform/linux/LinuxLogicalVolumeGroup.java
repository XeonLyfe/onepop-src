...
final class LinuxLogicalVolumeGroup extends AbstractLogicalVolumeGroup
{
    ...
    static List<LogicalVolumeGroup> getLogicalVolumeGroups() {
        ...
        return logicalVolumesMap.entrySet().stream().map(e -> new LinuxLogicalVolumeGroup(e.getKey(), e.getValue(), physicalVolumesMap.get(e.getKey()))).collect((Collector<? super Object, ?, List<LogicalVolumeGroup>>)Collectors.toList());
    }
}
