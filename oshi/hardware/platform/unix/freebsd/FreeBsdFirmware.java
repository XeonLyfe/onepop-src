...
final class FreeBsdFirmware extends AbstractFirmware
{
    ...
    FreeBsdFirmware() {
        this.manufVersRelease = (Supplier<Triplet<String, String, String>>)Memoizer.memoize(FreeBsdFirmware::readDmiDecode);
    }
    
    @Override
    public String getManufacturer() {
        return (String)this.manufVersRelease.get().getA();
    }
    
    @Override
    public String getVersion() {
        return (String)this.manufVersRelease.get().getB();
    }
    
    @Override
    public String getReleaseDate() {
        return (String)this.manufVersRelease.get().getC();
    }
