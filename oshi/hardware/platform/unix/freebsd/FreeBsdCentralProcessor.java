...
final class FreeBsdCentralProcessor extends AbstractCentralProcessor
{
    ...
    public long[][] queryProcessorCpuLoadTicks() {
        ...
        final Pointer p = (Pointer)new Memory(arraySize);
        final String name = "kern.cp_times";
        if (0 != FreeBsdLibc.INSTANCE.sysctlbyname(name, p, new IntByReference((int)arraySize), null, 0)) {
            FreeBsdCentralProcessor.LOG.error("Failed syctl call: {}, Error code: {}", (Object)name, (Object)Native.getLastError());
            return ticks;
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)FreeBsdCentralProcessor.class);
