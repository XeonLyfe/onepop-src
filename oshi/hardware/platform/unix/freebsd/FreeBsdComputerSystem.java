...
final class FreeBsdComputerSystem extends AbstractComputerSystem
{
    ...
    FreeBsdComputerSystem() {
        this.manufModelSerialUuidVers = (Supplier<Quintet<String, String, String, String, String>>)Memoizer.memoize(FreeBsdComputerSystem::readDmiDecode);
    }
    
    @Override
    public String getManufacturer() {
        return (String)this.manufModelSerialUuidVers.get().getA();
    }
    
    @Override
    public String getModel() {
        return (String)this.manufModelSerialUuidVers.get().getB();
    }
    
    @Override
    public String getSerialNumber() {
        return (String)this.manufModelSerialUuidVers.get().getC();
    }
    
    @Override
    public String getHardwareUUID() {
        return (String)this.manufModelSerialUuidVers.get().getD();
    }
    ...
    public Baseboard createBaseboard() {
        return new UnixBaseboard((String)this.manufModelSerialUuidVers.get().getA(), (String)this.manufModelSerialUuidVers.get().getB(), (String)this.manufModelSerialUuidVers.get().getC(), (String)this.manufModelSerialUuidVers.get().getE());
    }
