...
public class OpenBsdCentralProcessor extends AbstractCentralProcessor
{
    ...
    public OpenBsdCentralProcessor() {
        this.vmStats = (Supplier<Pair<Long, Long>>)Memoizer.memoize(OpenBsdCentralProcessor::queryVmStats, Memoizer.defaultExpiration());
    }
    ...
    protected long queryContextSwitches() {
        return (long)this.vmStats.get().getA();
    }
    
    @Override
    protected long queryInterrupts() {
        return (long)this.vmStats.get().getB();
    }
