...
final class OpenBsdSensors extends AbstractSensors
{
    ...
    OpenBsdSensors() {
        this.tempFanVolts = (Supplier<Triplet<Double, int[], Double>>)Memoizer.memoize(OpenBsdSensors::querySensors, Memoizer.defaultExpiration());
    }
    
    public double queryCpuTemperature() {
        return (double)this.tempFanVolts.get().getA();
    }
    
    public int[] queryFanSpeeds() {
        return (int[])this.tempFanVolts.get().getB();
    }
    
    public double queryCpuVoltage() {
        return (double)this.tempFanVolts.get().getC();
    }
