...
final class OpenBsdVirtualMemory extends AbstractVirtualMemory
{
    ...
    OpenBsdVirtualMemory(final OpenBsdGlobalMemory freeBsdGlobalMemory) {
        this.usedTotalPgin = (Supplier<Triplet<Integer, Integer, Integer>>)Memoizer.memoize(OpenBsdVirtualMemory::queryVmstat, Memoizer.defaultExpiration());
    ...
    public long getSwapUsed() {
        return (int)this.usedTotalPgin.get().getA() * this.global.getPageSize();
    }
    
    @Override
    public long getSwapTotal() {
        return (int)this.usedTotalPgin.get().getB() * this.global.getPageSize();
    }
    ...
    public long getSwapPagesIn() {
        return (int)this.usedTotalPgin.get().getC() * this.global.getPageSize();
    }
