...
public class MacUsbDevice extends AbstractUsbDevice
{
    ...
    private static void getControllerIdByLocation(final long id, final CoreFoundation.CFTypeRef locationId, final CoreFoundation.CFStringRef locationIDKey, final CoreFoundation.CFStringRef ioPropertyMatchKey, final Map<Long, String> vendorIdMap, final Map<Long, String> productIdMap) {
        final CoreFoundation.CFMutableDictionaryRef propertyDict = MacUsbDevice.CF.CFDictionaryCreateMutable(MacUsbDevice.CF.CFAllocatorGetDefault(), new CoreFoundation.CFIndex(0L), (Pointer)null, (Pointer)null);
        propertyDict.setValue((PointerType)locationIDKey, (PointerType)locationId);
        final CoreFoundation.CFMutableDictionaryRef matchingDict = MacUsbDevice.CF.CFDictionaryCreateMutable(MacUsbDevice.CF.CFAllocatorGetDefault(), new CoreFoundation.CFIndex(0L), (Pointer)null, (Pointer)null);
