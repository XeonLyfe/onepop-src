...
final class MacVirtualMemory extends AbstractVirtualMemory
{
    ...
    MacVirtualMemory(final MacGlobalMemory macGlobalMemory) {
        this.usedTotal = (Supplier<Pair<Long, Long>>)Memoizer.memoize(MacVirtualMemory::querySwapUsage, Memoizer.defaultExpiration());
        this.inOut = (Supplier<Pair<Long, Long>>)Memoizer.memoize(MacVirtualMemory::queryVmStat, Memoizer.defaultExpiration());
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)MacVirtualMemory.class);
    }
}
