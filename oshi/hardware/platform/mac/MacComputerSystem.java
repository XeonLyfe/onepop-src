...
final class MacComputerSystem extends AbstractComputerSystem
{
    ...
    MacComputerSystem() {
        this.manufacturerModelSerialUUID = (Supplier<Quartet<String, String, String, String>>)Memoizer.memoize(MacComputerSystem::platformExpert);
    }
    
    @Override
    public String getManufacturer() {
        return (String)this.manufacturerModelSerialUUID.get().getA();
    }
    
    @Override
    public String getModel() {
        return (String)this.manufacturerModelSerialUUID.get().getB();
    }
    
    @Override
    public String getSerialNumber() {
        return (String)this.manufacturerModelSerialUUID.get().getC();
    }
    
    @Override
    public String getHardwareUUID() {
        return (String)this.manufacturerModelSerialUUID.get().getD();
    }
