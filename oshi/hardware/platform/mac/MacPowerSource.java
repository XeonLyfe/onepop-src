...
public final class MacPowerSource extends AbstractPowerSource
{
    ...
    public static List<PowerSource> getPowerSources() {
        ...
        final IOKit.IORegistryEntry smartBattery = (IOKit.IORegistryEntry)IOKitUtil.getMatchingService("AppleSmartBattery");
        ...
        for (int ps = 0; ps < powerSourcesCount; ++ps) {
            ...
            if (result != null) {
                ...
                if (0 != MacPowerSource.CF.CFBooleanGetValue(isPresentRef)) {
                    ...
                    final CoreFoundation.CFStringRef cfName = new CoreFoundation.CFStringRef(result);
                    String psName = cfName.stringValue();
                    if (psName == null) {
                        psName = "unknown";
                    }
                    double currentCapacity = 0.0;
                    if (dictionary.getValueIfPresent((PointerType)currentCapacityKey, (PointerByReference)null)) {
                    ...
                    if (dictionary.getValueIfPresent((PointerType)maxCapacityKey, (PointerByReference)null)) {
