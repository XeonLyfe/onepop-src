...
final class WindowsVirtualMemory extends AbstractVirtualMemory
{
    ...
    WindowsVirtualMemory(final WindowsGlobalMemory windowsGlobalMemory) {
        ...
        this.totalVmaxVused = (Supplier<Triplet<Long, Long, Long>>)Memoizer.memoize(WindowsVirtualMemory::querySwapTotalVirtMaxVirtUsed, Memoizer.defaultExpiration());
        this.swapInOut = (Supplier<Pair<Long, Long>>)Memoizer.memoize(WindowsVirtualMemory::queryPageSwaps, Memoizer.defaultExpiration());
    ...
    public long getSwapTotal() {
        return this.global.getPageSize() * (long)this.totalVmaxVused.get().getA();
    }
    
    @Override
    public long getVirtualMax() {
        return this.global.getPageSize() * (long)this.totalVmaxVused.get().getB();
    }
    
    @Override
    public long getVirtualInUse() {
        return this.global.getPageSize() * (long)this.totalVmaxVused.get().getC();
    }
    
    @Override
    public long getSwapPagesIn() {
        return (long)this.swapInOut.get().getA();
    }
    
    @Override
    public long getSwapPagesOut() {
        return (long)this.swapInOut.get().getB();
    }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)WindowsVirtualMemory.class);
    }
}
