...
final class WindowsComputerSystem extends AbstractComputerSystem
{
    ...
    WindowsComputerSystem() {
        this.manufacturerModel = (Supplier<Pair<String, String>>)Memoizer.memoize(WindowsComputerSystem::queryManufacturerModel);
        this.serialNumberUUID = (Supplier<Pair<String, String>>)Memoizer.memoize(WindowsComputerSystem::querySystemSerialNumberUUID);
    }
    
    @Override
    public String getManufacturer() {
        return (String)this.manufacturerModel.get().getA();
    }
    
    @Override
    public String getModel() {
        return (String)this.manufacturerModel.get().getB();
    }
    
    @Override
    public String getSerialNumber() {
        return (String)this.serialNumberUUID.get().getA();
    }
    
    @Override
    public String getHardwareUUID() {
        return (String)this.serialNumberUUID.get().getB();
    }
