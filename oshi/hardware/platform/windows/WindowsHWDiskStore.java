...
public final class WindowsHWDiskStore extends AbstractHWDiskStore
{
    ...
    public boolean updateAttributes() {
        ...
        if (!partitions.isEmpty()) {
            ...
            if (!this.getName().startsWith("\\\\.\\PHYSICALDRIVE")) {
                WindowsHWDiskStore.LOG.warn("Couldn't match index for {}", (Object)this.getName());
                return false;
            }
    ...
    public static List<HWDiskStore> getDisks() {
        final WmiQueryHandler h = WmiQueryHandler.createInstance();
        ...
        try {
            ...
            WindowsHWDiskStore.LOG.warn("COM exception: {}", (Object)e.getMessage());
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)WindowsHWDiskStore.class);
