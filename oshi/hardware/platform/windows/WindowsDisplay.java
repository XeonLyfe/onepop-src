...
final class WindowsDisplay extends AbstractDisplay
{
    ...
    public static List<Display> getDisplays() {
        ...
        final WinNT.HANDLE hDevInfo = WindowsDisplay.SU.SetupDiGetClassDevs(WindowsDisplay.GUID_DEVINTERFACE_MONITOR, (Pointer)null, (Pointer)null, 18);
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)WindowsDisplay.class);
