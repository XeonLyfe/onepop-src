...
public abstract class AbstractNetworkIF implements NetworkIF
{
    ...
    private static List<NetworkInterface> getAllNetworkInterfaces() {
        try {
            ...
            AbstractNetworkIF.LOG.error("Socket exception when retrieving interfaces: {}", (Object)ex.getMessage());
    ...
    private static boolean isLocalInterface(final NetworkInterface networkInterface) {
        try {
            ...
            AbstractNetworkIF.LOG.error("Socket exception when retrieving interface information for {}: {}", (Object)networkInterface, (Object)e.getMessage());
            return false;
        }
    }
    ...
    public String toString() {
        ...
        sb.append("  MTU: ").append(ParseUtil.unsignedIntToLong(this.getMTU())).append(", ").append("Speed: ").append(this.getSpeed()).append("\n");
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)AbstractNetworkIF.class);
    }
}
