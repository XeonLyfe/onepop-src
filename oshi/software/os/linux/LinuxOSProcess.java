...
public class LinuxOSProcess extends AbstractOSProcess
{
    ...
    public String getCurrentWorkingDirectory() {
        try {
            ...
            LinuxOSProcess.LOG.trace("Couldn't find cwd for pid {}: {}", (Object)this.getProcessID(), (Object)e.getMessage());
        }
        return "";
    }
    ...
    private int queryBitness() {
        ...
        if (!this.path.isEmpty()) {
            try (final InputStream is = new FileInputStream(this.path)) {
                ...
                LinuxOSProcess.LOG.warn("Failed to read process file: {}", (Object)this.path);
            }
        }
        return 0;
    }
    ...
    public boolean updateAttributes() {
        ...
        catch (InvalidPathException | IOException | UnsupportedOperationException | SecurityException ex) {
            final Exception ex2;
            final Exception e = ex2;
            LinuxOSProcess.LOG.debug("Unable to open symbolic link {}", (Object)procPidExe);
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)LinuxOSProcess.class);
