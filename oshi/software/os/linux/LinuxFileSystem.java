...
public class LinuxFileSystem extends AbstractFileSystem
{
        ...
        if (volumes != null) {
            for (final File volume : volumes) {
                try {
                    ...
                    LinuxFileSystem.LOG.error("Couldn't get canonical path for {}. {}", (Object)volume.getName(), (Object)e.getMessage());
                }
            }
        }
        ...
        if (uuids != null) {
            for (final File uuid : uuids) {
                try {
                    ...
                    LinuxFileSystem.LOG.error("Couldn't get canonical path for {}. {}", (Object)uuid.getName(), (Object)e2.getMessage());
                }
            }
        }
        ...
        for (final String mount : mounts) {
            ...
            if (link.toFile().exists() && Files.isSymbolicLink(link)) {
                try {
                    ...
                    LinuxFileSystem.LOG.warn("Couldn't access symbolic path  {}. {}", (Object)link, (Object)e.getMessage());
                }
            }
            long totalInodes = 0L;
            long freeInodes = 0L;
            ...
            try {
                ...
                if (0 == LibC.INSTANCE.statvfs(path, vfsStat)) {
                    ...
                    LinuxFileSystem.LOG.warn("Failed to get information to use statvfs. path: {}, Error code: {}", (Object)path, (Object)Native.getLastError());
                }
            }
                ...
                LinuxFileSystem.LOG.error("Failed to get file counts from statvfs. {}", (Object)e2.getMessage());
            }
            if (totalSpace == 0L) {
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)LinuxFileSystem.class);
