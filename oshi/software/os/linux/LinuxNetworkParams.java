...
final class LinuxNetworkParams extends AbstractNetworkParams
{
    ...
    public String getDomainName() {
        ...
        try {
            ...
            LinuxNetworkParams.LOG.error("Unknown host exception when getting address of local host: {}", (Object)e.getMessage());
            return "";
        }
        ...
        if (res > 0) {
            if (LinuxNetworkParams.LOG.isErrorEnabled()) {
                LinuxNetworkParams.LOG.error("Failed getaddrinfo(): {}", (Object)LinuxNetworkParams.LIBC.gai_strerror(res));
            }
            return "";
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)LinuxNetworkParams.class);
