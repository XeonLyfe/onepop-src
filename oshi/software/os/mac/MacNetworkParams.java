...
final class MacNetworkParams extends AbstractNetworkParams
{
    ...
    public String getDomainName() {
        ...
        try {
            ...
            MacNetworkParams.LOG.error("Unknown host exception when getting address of local host: {}", (Object)e.getMessage());
            return "";
        }
        ...
        if (res > 0) {
            if (MacNetworkParams.LOG.isErrorEnabled()) {
                MacNetworkParams.LOG.error("Failed getaddrinfo(): {}", (Object)MacNetworkParams.SYS.gai_strerror(res));
            }
            return "";
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)MacNetworkParams.class);
