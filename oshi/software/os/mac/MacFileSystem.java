...
public class MacFileSystem extends AbstractFileSystem
{
                        ...
                        if (nameToMatch == null || nameToMatch.equals(name)) {
                            ...
                            if (bsdName.startsWith("disk")) {
                                ...
                                if (disk != null) {
                                    ...
                                    if (diskInfo != null) {
                                        final Pointer result = diskInfo.getValue((PointerType)daVolumeNameKey);
                                        if (result != null) {
                                            final CoreFoundation.CFStringRef volumePtr = new CoreFoundation.CFStringRef(result);
                                ...
                                if (matchingDict != null) {
                                    final IOKit.IOIterator fsIter = IOKitUtil.getMatchingServices((CoreFoundation.CFDictionaryRef)matchingDict);
                                    if (fsIter != null) {
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)MacFileSystem.class);
