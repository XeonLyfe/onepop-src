...
final class WindowsNetworkParams extends AbstractNetworkParams
{
    ...
    public String[] getDnsServers() {
        ...
        final Memory buffer = new Memory((long)bufferSize.getValue());
        ...
        final IPHlpAPI.FIXED_INFO fixedInfo = new IPHlpAPI.FIXED_INFO((Pointer)buffer);
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)WindowsNetworkParams.class);
    }
}
