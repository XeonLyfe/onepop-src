...
final class FreeBsdNetworkParams extends AbstractNetworkParams
{
    ...
    public String getDomainName() {
        ...
        if (res > 0) {
            if (FreeBsdNetworkParams.LOG.isErrorEnabled()) {
                FreeBsdNetworkParams.LOG.warn("Failed getaddrinfo(): {}", (Object)FreeBsdNetworkParams.LIBC.gai_strerror(res));
            }
            return "";
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)FreeBsdNetworkParams.class);
