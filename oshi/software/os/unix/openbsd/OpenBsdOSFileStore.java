...
public class OpenBsdOSFileStore extends AbstractOSFileStore
{
    ...
    public boolean updateAttributes() {
        for (final OSFileStore fileStore : OpenBsdFileSystem.getFileStoreMatching(this.getName())) {
            if (this.getName().equals(fileStore.getName()) && this.getVolume().equals(fileStore.getVolume()) && this.getMount().equals(fileStore.getMount())) {
