...
public final class EdidUtil
{
    ...
    public static String getManufacturerID(final byte[] edid) {
        ...
        EdidUtil.LOG.debug("Manufacurer ID: {}", (Object)temp);
    ...
    public static String getSerialNo(final byte[] edid) {
        if (EdidUtil.LOG.isDebugEnabled()) {
            EdidUtil.LOG.debug("Serial number: {}", (Object)Arrays.toString(Arrays.copyOfRange(edid, 12, 16)));
        }
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)EdidUtil.class);
    }
}
