...
public final class NetStat
{
    ...
    public static Map<Integer, IFdata> queryIFdata(final int index) {
        ...
        final Memory buf = new Memory((long)len.getValue());
        if (0 != SystemB.INSTANCE.sysctl(mib, 6, (Pointer)buf, len, (Pointer)null, 0)) {
        ...
        int offset = 0;
        while (offset < lim) {
            final Pointer p = buf.share((long)offset);
    ...
    static {
        LOG = LoggerFactory.getLogger((Class)NetStat.class);
    }
