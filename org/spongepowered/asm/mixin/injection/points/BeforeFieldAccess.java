...
public class BeforeFieldAccess extends BeforeInvoke
{
    ...
    protected boolean matchesInsn(final AbstractInsnNode insn) {
        return insn instanceof FieldInsnNode && (insn.getOpcode() == this.opcode || this.opcode == -1) && (this.arrOpcode == 0 || ((insn.getOpcode() == 178 || insn.getOpcode() == 180) && Type.getType(((FieldInsnNode)insn).desc).getSort() == 9));
    }
