...
public class SettingBooleanWidget extends Widget
{
    ...
    private ComponentSetting<Boolean> setting;
    private int alphaAnimationPressed;
    private boolean isMouseClickedLeft;
    private boolean isRendering;
    public Flag flagMouse;
    
    public SettingBooleanWidget(final ComponentClickGUI master, final ComponentListFrame frame, final ComponentWidget module, final ComponentSetting<Boolean> setting) {
    ...
    public void onRender() {
        ...
        TurokFontManager.render(this.master.fontWidgetComponent, this.rect.getTag(), this.rect.getX() + 1.0f, this.rect.getY() + 3.0f, true, new Color(255, 255, 255));
    }
