...
public class SettingBooleanWidget extends Widget
{
    ...
    public SettingBooleanWidget(final ModuleClickGUI master, final CategoryFrame frame, final ModuleScrollContainer container, final ModuleWidget module, final ValueBoolean setting) {
    ...
    public void onRender() {
        ...
        TurokFontManager.render(this.master.fontWidgetModule, this.rect.getTag(), this.rect.getX() + 1.0f, this.rect.getY() + 3.0f, true, new Color(255, 255, 255));
    }
